...
import com.freudas.dev.security.*;
import com.freudas.dev.security.oauth2.CustomOAuth2UserService;
import com.freudas.dev.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import com.freudas.dev.security.oauth2.OAuth2AuthenticationFailureHandler;
import com.freudas.dev.security.oauth2.OAuth2AuthenticationSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    final private OAuth2AuthenticationFailureHandler oAuth2AuthenticationFailureHandler;
        ...
        http
                ...
                .authorizeRequests()
                    .antMatchers("/",
                        ...
                        "/**/*.js")
                        .permitAll()
                    .antMatchers("/api/v1/auth/**","/api/v1/test/**", "/oauth2/**")
                        .permitAll()
