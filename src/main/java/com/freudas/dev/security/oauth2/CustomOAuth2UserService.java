package com.freudas.dev.security.oauth2;
...
import com.freudas.dev.security.oauth2.user.OAuth2UserInfo;
import com.freudas.dev.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        switch (AuthProvider.valueOf(oAuth2UserRequest.getClientRegistration().getRegistrationId())) {
            case local -> user.setRole(Constants.LIFE_USER_ROLE);
            case google -> user.setRole(Constants.WORK_USER_ROLE);
        }
